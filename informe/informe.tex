...
Por otro lado, como la mayoría de los CB que observamos en la experimentación preliminar tardaban unos pocos segundos, pusimos un tope de tiempo de 50 segundos para CPLEX. 
...
\diagramavfig{david_comparandoRandomsYAlgoritmos}{instancias david CB vs BB}
...
\diagramavfig{input0_comparandoRandomsYAlgoritmos}{instancias input0 CB vs BB}
\diagramavfig{myciel3_comparandoRandomsYAlgoritmos}{instancias myciel3 CB vs BB}
...
% TAMBIEN HABRIA QUE VER QUE CONSUMIMOS MENOS MEMORIA (NODOS?)
