...
Realizamos uno de estos gráficos para cada combinación de archivo (``david'', ``myciel'',  ``input01''), cada algoritmo (``BB'' y ``CB'') y cada modelo(``Modelo Pedro'' y ``Modelo Santiago''). A su vez, cada archivo representa un grafo que lo particionamos de distintas maneras(``notrandom'', ``random0.2'', ``random0.4'', ``random0.8'', ``random1.0'').
...
\subsection{Experimentación de Modelo Pedro}

...hacer...

\diagramavfig{david_notrandom_1_bb_0_segunJuntada}{Caption de muestra}
